...
CREATE TABLE `commentaire` (
  ...
  `utilisateur_like_post` smallint unsigned DEFAULT NULL,
  `utilisateur_dislike_post` smallint unsigned DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `post` (
  ...
  `utilisateur_post` smallint unsigned NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `utilisateur` (
  ...
  `type_droit` varchar(20) DEFAULT 'utilisateur',
  PRIMARY KEY (`id`),
...
-- Dump completed on 2020-11-23 22:49:30
